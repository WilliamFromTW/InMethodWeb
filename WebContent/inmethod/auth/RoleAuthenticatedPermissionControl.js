var myDivClassName="DivRoleAuthenticatedPermissionControl";
var myDivStatusIDName="changeFunctionInfoStatus";
var sFunctionName = "RoleAuthenticatedPermissionControlServlet";
		        ...
		        deleteItem: function(ItemData) {
                   var result = $.Deferred();
		        	...
		        	$.getJSON(sFunctionUrl, {
		             ...
		             .fail(function(s) {
                        alert("fail"+s.status+",responseText="+s.responseText);
