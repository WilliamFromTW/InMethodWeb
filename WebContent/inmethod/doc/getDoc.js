...
$(function() {
	...
	function PassToBackEnd() {
		...
		$.when(
		$.getJSON(sFunctionBackEndUrl,{"FlowID":"getDoc"}),		
		$.getJSON(sFunctionBackEndUrl,{"FlowID":"getDoc2"})
		).done( function(d1,d2) {
			...
			if (d1[0].STATUS == 'TRUE'){
			  ...
			  onClickRow:function(row, $element, field){
				...
				if(  row.upload_path!==null && row.upload_path!== "undefined" && row.upload_path!==''){
                   $("#table-subject").html("<thead  class=\" table-secondary\"><tr ><th><font color='red'>Document Description</font></th></tr></thead><tbody><tr><th><font color='blue'>"+ nl2br( row.message,true)+"<br/><br/>&nbsp;"+"<a href='downloadDocument?FileID="+row.upload_path.split('\\').pop().split('/').pop() +"''><br/>download</a></th></tr></tbody>");
                 }
				else
               $("#table-subject").html("<thead  class=\" table-secondary\"><tr ><th><font color='red'>Document Description</font></th></tr></thead><tbody><tr><th><font color='blue'>"+ nl2br( row.message,true)+"</font></th></tr></tbody>");
             }
             }  
             )	
