		    ...
		    fields: [
			   {
		        ...
		        { name: "UserId",title: "Employee ID",css: "jsgrid", type: "text",width: 30,editing:false,align: "left"},
		        ...
		        { name: "UserDeptId",title: "Department ID",css: "jsgrid", type: "select",width: 30,align: "left",
		        	items:jsonJsGridSelectOptions1[0],
        		    textField: "Name",        	
        		    valueField: "Value"		        	
		        },
		        { name: "UserMail",title: "E-Mail",css: "jsgrid", type: "text",width: 30,align: "left"},
		        { name: "UserOnboradDate",title: "Onboard Date",css: "jsgrid", type: "text",width: 30,align: "right"},
		        { name: "UserDepartureDate",title: "Departure Date",css: "jsgrid", type: "text",width: 30,align: "right"},
