		    ...
		    fields: [
			   {
		        ...
		        { name: "UserId",title: "Employee ID",css: "jsgrid", type: "text",width: 30,editing:false,align: "center"},
		        { name: "UserName",title: "Name",css: "jsgrid", type: "text",width: 30,align: "center"},
		        { name: "UserEnglishName",title: "English Name",css: "jsgrid", type: "text",width: 30,align: "center"},
		        { name: "UserDeptId",title: "Department ID",css: "jsgrid", type: "select",width: 30,
		        	items:jsonJsGridSelectOptions1[0],
        		    textField: "Name",        	
        		    valueField: "Value"		        	
		        },
		        { name: "UserMail",title: "E-Mail",css: "jsgrid", type: "text",width: 30,align: "center"},
		        { name: "UserOnboradDate",title: "Onboard Date",css: "jsgrid", type: "text",width: 30,align: "center"},
		        { name: "UserDepartureDate",title: "Departure Date",css: "jsgrid", type: "text",width: 30,align: "center"},
		        { name: "UserLanguage",title: "Language",css: "jsgrid", type: "select",width: 30,align: "left",
    	            items:[
	                     {"Name":"","Value":""},
