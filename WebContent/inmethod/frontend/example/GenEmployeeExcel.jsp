...
<script>
  ...
  // 修改以下程式名稱
  var sFunctionName = "GenEmployeeExcel";   // 程式基本資料ID
  var sFunctionJspUrl = "inmethod/frontend/example/GenEmployeeExcel.jsp";
  var sFunctionJsUrl = "inmethod/frontend/example/GenEmployeeExcel.js";
  var sFunctionBackEndUrl = "inmethod/backend/example/GenEmployeeExcel";
